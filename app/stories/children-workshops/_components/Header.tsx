      ...
      <div className="relative w-full flex flex-col lg:flex-row min-h-[calc(100vh-8rem)]">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 pt-16 pb-20 lg:pt-24 lg:pb-24 relative z-10">
          ...
          <div className="max-w-xl">
            ...
            >
              Inspire the next generation of eco-warriors. Our immersive, nature-based workshops reconnect children with the earth, teaching them the vital importance of biodiversity, conservation, and sustainable living through hands-on discovery.
            </motion.p>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 relative min-h-[50vh] lg:min-h-full overflow-hidden">
          <motion.img
            ...
            // A beautiful image of children learning outdoors/in nature
            src="https://images.unsplash.com/photo-1542838686-330b62e4c45b?q=80&w=1600&auto=format&fit=crop"
            alt="Children discovering nature during a workshop"
