    ...
    <header className={`${bebasNeue.variable} ${outfit.variable} relative w-full py-[20vh] md:py-[30vh] bg-[#0a0d08] overflow-hidden flex items-center justify-center`}>
      ...
      <div className="relative z-20 flex flex-col items-center text-center px-6 max-w-4xl mx-auto mt-10">
        ...
        <motion.h1
          ...
          className="text-[clamp(60px,12vw,140px)] text-white font-[family-name:var(--font-bebas)] leading-[0.85] tracking-wide mb-8"
        >
          DEFENDING <br /> THE WILD
        </motion.h1>
        ...
        >
          The 5F Eco Foundation of India is dedicated to the rescue, conservation, and restoration of vulnerable ecosystems. We stand as the frontline defense between human expansion and the preservation of our planet's most majestic species.
        </motion.p>
      </div>
